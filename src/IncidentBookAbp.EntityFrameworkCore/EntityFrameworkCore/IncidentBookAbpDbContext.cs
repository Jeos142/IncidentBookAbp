...
public class IncidentBookAbpDbContext :
    AbpDbContext<IncidentBookAbpDbContext>,
    ...
    IIdentityDbContext
{
    ...
    public IncidentBookAbpDbContext(DbContextOptions<IncidentBookAbpDbContext> options)
        : base(options)
    {
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        builder.ConfigureIncidentBookAbp();
    }
}

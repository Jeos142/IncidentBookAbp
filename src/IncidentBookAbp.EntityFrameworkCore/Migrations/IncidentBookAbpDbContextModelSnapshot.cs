...
{
    [DbContext(typeof(IncidentBookAbpDbContext))]
    partial class IncidentBookAbpDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IncidentBookAbp.Clients.Client", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("IncidentBookAbp.IncidentClassifications.IncidentClassification", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppIncidentClassifications", (string)null);
                });

            modelBuilder.Entity("IncidentBookAbp.Incidents.Incident", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("ClassificationId1")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ResolutionId1");

                    b.ToTable("AppIncidents", (string)null);
                });

            modelBuilder.Entity("IncidentBookAbp.Resolutions.Resolution", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppResolutions", (string)null);
                });
            ...
            modelBuilder.Entity("IncidentBookAbp.Incidents.Incident", b =>
                {
                    b.HasOne("IncidentBookAbp.IncidentClassifications.IncidentClassification", null)
                        .WithMany()
                        .HasForeignKey("ClassificationId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("IncidentBookAbp.IncidentClassifications.IncidentClassification", "Classification")
                        .WithMany()
                        .HasForeignKey("ClassificationId1");

                    b.HasOne("IncidentBookAbp.Clients.Client", null)
                        .WithMany()
                        .HasForeignKey("ClientId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("IncidentBookAbp.Clients.Client", "Client")
                        .WithMany()
                        .HasForeignKey("ClientId1");

                    b.HasOne("IncidentBookAbp.Resolutions.Resolution", null)
                        .WithMany()
                        .HasForeignKey("ResolutionId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("IncidentBookAbp.Resolutions.Resolution", "Resolution")
                        .WithMany()
                        .HasForeignKey("ResolutionId1");

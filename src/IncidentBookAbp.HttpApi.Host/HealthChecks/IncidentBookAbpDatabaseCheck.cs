...
public class IncidentBookAbpDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public IncidentBookAbpDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
